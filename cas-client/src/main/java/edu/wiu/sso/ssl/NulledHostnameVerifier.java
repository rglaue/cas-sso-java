 ...
 * certificate's SubjectDN CommonName is 'java.com', the default
 * javax.net.ssl.HostnameVerifier does a String.equals() on those two
...
public class NulledHostnameVerifier implements javax.net.ssl.HostnameVerifier
{
     ...
     * @see                 javax.net.ssl.HostnameVerifier#verify
